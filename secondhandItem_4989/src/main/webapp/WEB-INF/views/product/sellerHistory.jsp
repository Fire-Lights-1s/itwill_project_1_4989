...
<section>
	<header>
		<div id="menu-name">
   			...
   			<a href="${pageContext.request.contextPath}/product/sellerHistory">dfagfadqweqdasd님의 판매 내역</a>
		</div>
	</header>
...
<!-- 				처음 페이지 아닌 경우 이전 버튼 보이기 -->
				...
				<c:forEach var="i" begin="${pageDTO.startPage}" end="${pageDTO.endPage}" step="1">
					<c:if test="${pageDTO.currentPage eq i}">
						<a href="#"><span class="pagenum currentpage">${i}0</span></a>
					</c:if>
					<c:if test="${pageDTO.currentPage ne i}">
						<a href="#"><span class="pagenum">${i}0</span></a>
					</c:if>
				</c:forEach>
