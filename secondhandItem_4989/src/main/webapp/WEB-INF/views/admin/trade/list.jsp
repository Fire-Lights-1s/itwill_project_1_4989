		...
		<div class="page-container">
					...
					<div class="container-fluid">
						<div class="header-wrap">
							<div class="header-button">
								<a href="${pageContext.request.contextPath}/" class="btn-home">홈페이지로
									가기</a> <a href="${pageContext.request.contextPath}/member/logout"
			...
			<div class="main-content">
				...
				<div class="input-group mb-3 flex-right-50pct">
					<form action="${pageContext.request.contextPath}/admin/trade"
						style="display: flex;">
...
${trade.formattedTransactionEndDate}
                        ...
                        N/A
									...
									<td class="text-center"><a
										href="${pageContext.request.contextPath}/admin/tradeDetail?product_id=${trade.product_id}">
				...
				<div class="position-relative">
					<ul class="pagination justify-content-end">
						<li class="page-item"><a class="page-link"
							href="${pageContext.request.contextPath}/admin/trade?pageNum=1">
								<img
						...
						<c:if test="${pageDTO.currentPage > 10}">
							<li class="page-item"><a class="page-link"
								href="${pageContext.request.contextPath}/admin/trade?pageNum=${pageDTO.startPage - 1}">
									<img
									src="${pageContext.request.contextPath}/resources/img/btn_prevpage.png"
									alt="이전">
							</a></li>
						</c:if>
						<c:forEach var="page" begin="${pageDTO.startPage}"
							end="${pageDTO.endPage}">
							<li class="page-item"><a class="page-link"
								href="${pageContext.request.contextPath}/admin/trade?pageNum=${page}"
								${pageDTO.currentPage eq page ? 'class="active"' : ''}>${page}</a>
							</li>
						</c:forEach>
						<c:if test="${pageDTO.currentPage + 10 <= pageDTO.pageCount}">
							<li class="page-item"><a class="page-link"
								href="${pageContext.request.contextPath}/admin/trade?pageNum=${pageDTO.endPage + 1}">
									<img
						...
						<li class="page-item"><a class="page-link"
							href="${pageContext.request.contextPath}/admin/trade?pageNum=${pageDTO.pageCount}">
								<img
